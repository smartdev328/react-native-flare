...
export const CANCEL_ACTIVE_FLARE_FAILURE =
    'flare.app.CANCEL_ACTIVE_FLARE_FAILURE';
export const CANCEL_ACTIVE_FLARE_REQUEST =
    'flare.app.CANCEL_ACTIVE_FLARE_REQUEST';
export const CANCEL_ACTIVE_FLARE_SUCCESS =
    'flare.app.CANCEL_ACTIVE_FLARE_SUCCESS';
...
export const DEVICE_CLAIM_FAILURE = 'flare.app.device.claim.FAILURE';
...
export const DEVICE_CLAIM_RESET = 'flare.app.device.claim.RESET';
...
export const GET_FLARE_TIMELINE_FAILURE =
    'flare.app.GET_FLARE_TIMELINE_FAILURE';
export const GET_FLARE_TIMELINE_REQUEST =
    'flare.app.GET_FLARE_TIMELINE_REQUEST';
export const GET_FLARE_TIMELINE_SUCCESS =
    'flare.app.GET_FLARE_TIMELINE_SUCCESS';

export const SETTINGS_SET_POPUP_MESSAGE_FAILURE =
    'flare.app.SET_POPUP_MESSAGE_FAILURE';
export const SETTINGS_SET_POPUP_MESSAGE_REQUEST =
    'flare.app.SET_POPUP_MESSAGE_REQUEST';
export const SETTINGS_SET_POPUP_MESSAGE_SUCCESS =
    'flare.app.SET_POPUP_MESSAGE_SUCCESS';

export const USER_SET_NOTIFICATIONS_ENABLED =
    'flare.app.SET_NOTIFICATIONS_ENABLED';

export const MANUFACTURING_BEACON_FAILURE =
    'flare.manufacturing.BEACON_FAILURE';
export const MANUFACTURING_BEACON_REQUEST =
    'flare.manufacturing.BEACON_REQUEST';
export const MANUFACTURING_BEACON_SUCCESS =
    'flare.manufacturing.BEACON_SUCCESS';

export const MANUFACTURING_GET_DEVICES_FAILURE =
    'flare.manufacturing.GET_DEVICES_FAILURE';
export const MANUFACTURING_GET_DEVICES_REQUEST =
    'flare.manufacturing.GET_DEVICES_REQUEST';
export const MANUFACTURING_GET_DEVICES_SUCCESS =
    'flare.manufacturing.GET_DEVICES_SUCCESS';
...
export const SET_USER_DETAILS_FAILURE = 'flare.app.SET_USER_DETAILS_FAILURE';
export const SET_USER_DETAILS_REQUEST = 'flare.app.SET_USER_DETAILS_REQUEST';
export const SET_USER_DETAILS_SUCCESS = 'flare.app.SET_USER_DETAILS_SUCCESS';
...
export const USER_SET_ONBOARDING_COMPLETE_RESET =
    'flare.app.USER_SET_ONBOARDING_COMPLETE_RESET';
export const USER_SET_ONBOARDING_COMPLETE_FAILURE =
    'flare.app.USER_SET_ONBOARDING_COMPLETE_FAILURE';
export const USER_SET_ONBOARDING_COMPLETE_REQUEST =
    'flare.app.USER_SET_ONBOARDING_COMPLETE_REQUEST';
export const USER_SET_ONBOARDING_COMPLETE_SUCCESS =
    'flare.app.USER_SET_ONBOARDING_COMPLETE_SUCCESS';

export const USER_SET_PRIVACY_CONFIG_FAILURE =
    'flare.app.USER_SET_PRIVACY_CONFIG_FAILURE';
export const USER_SET_PRIVACY_CONFIG_REQUEST =
    'flare.app.USER_SET_PRIVACY_CONFIG_REQUEST';
export const USER_SET_PRIVACY_CONFIG_SUCCESS =
    'flare.app.USER_SET_PRIVACY_CONFIG_SUCCESS';

export const USER_SET_CALL_SCRIPT_FAILURE =
    'flare.app.USER_SET_CALL_SCRIPT_FAILURE';
export const USER_SET_CALL_SCRIPT_REQUEST =
    'flare.app.USER_SET_CALL_SCRIPT_REQUEST';
...
export const USER_SAW_NOTIF_SETTINGS = 'flare.app.USER_SAW_NOTIF_SETTINGS';
export const USER_WILL_SHARE = 'flare.app.USER_WILL_SHARE';
export const USER_DID_SHARE = 'flare.app.USER_DID_SHARE';
...
export const USER_SCENARIO_AWAIT_LONG_PRESS =
    'flare.app.USER_SCENARIO_AWAIT_LONG_PRESS';
export const USER_SCENARIO_GOT_LONG_PRESS =
    'flare.USER_SCENARIO_GOT_LONG_PRESS';
export const USER_SCENARIO_GOT_SHORT_WHILE_AWAITING_LONG =
    'flare.app.USER_SCENARIO_GOT_SHORT_WHILE_AWAITING_LONG';
...
export const HIDE_911_FEATURE_FAILURE_ALERT =
    'flare.app.HIDE_911_FEATURE_FAILURE_ALERT';

export const USER_SET_CREW_ENABLED = 'flare.app.USER_SET_CREW_ENABLED';
