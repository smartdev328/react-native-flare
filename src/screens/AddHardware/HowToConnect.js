        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollContainer}>
                ...
                <Text style={styles.helpText}>
                    By pushing the discreet button on your cuff, your phone and
                    the cuff can establish a connection.
                    {'\n\n'}
                ...
                <Text style={styles.helpText}>
                    In order to ensure that we connect to the right cuff, you
                    can always enter the serial number manually so that your
                    phone and cuff can establish a connection.
                    {'\n\n'}
